...
public class Cookies {
    ...
    public int countTotal(String str) {
        stringArray = str.split("(c|C).....(s|S)");
        return stringArray.length-1;
    }

    public String getStringOfPrices(String str) {
        stringArray = str.split("((c|C).....(s|S))([;:, @, ^, *, %])(p|P)...(e|E)([;:, @, ^, *, %])");
    ...
    public String[] getStringPriceArray(String str) {
        String[] priceStringArray = str.split("[^(\\d|\\.)]");
    ...
    public String makeOutputString(String str) {
        ...
        outputString = String.format("%s %6s %9s %s", "name:", item, "seen: ", countTotal(jsonString) + " times \n");
