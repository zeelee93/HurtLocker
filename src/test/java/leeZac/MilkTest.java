...
public class MilkTest {
    ...
    public void makeListOfPricesTest() {
        int expected = 6;
        int actual = milk.makeListOfPrices(jsonString).size();
    ...
    public void ListOfStringsTest() {
        ...
        listStrings = milk.makeListOfPrices(jsonString);
        System.out.println(listStrings);
        int actual = milk.removeErrorsInList(listStrings).size();
        Assert.assertEquals("should be 6 matches", expected, actual);
    }

    @Test
    public void makeMapOfPricesTest() {
        mapOfPrices = milk.makeMapOfPrices(milk.removeErrorsInList(milk.makeListOfPrices(jsonString)));
    ...
    public void OutputTest() {
        String str = milk.makeOutputString(jsonString);
